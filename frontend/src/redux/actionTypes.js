...
export const CREATE_SUBTAGS_REQUEST = 'CREATE_SUBTAGS_REQUEST';
export const CREATE_SUBTAGS_SUCCESS = 'CREATE_SUBTAGS_SUCCESS';
export const CREATE_SUBTAGS_FAILURE = 'CREATE_SUBTAGS_FAILURE';
